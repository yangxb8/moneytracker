...
const AssetsIconsPack: IconPack<ImageProps | SvgProps> = {
  ...
  icons: {
    ...
    'checkmark_linear': createIcon(Icons['checkmark_linear']),
    'checkmark': createIcon(Icons['checkmark']),
    'no_ads': createIcon(Icons['no_ads']),
    'wallet_open': createIcon(Icons['wallet_open']),
    'cloud': createIcon(Icons['cloud']),
    'caret_linear': createIcon(Icons['caret_linear']),
    'clock_wise': createIcon(Icons['clock_wise']),
  },
};
